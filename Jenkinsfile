...
pipeline {
  ...
  stages {
    ...
    //             sh """
    //             mvn sonar:sonar \
    //             -Dsonar.projectKey=Prosperous-CI-CD-Project \
    //             -Dsonar.host.url=http://34.211.193.23:9000 \
  ...
  post {
    always {
        ...
        slackSend channel: '#prosperous-ci-cd-jenkins', //update and provide your channel name
